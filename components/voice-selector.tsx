            ...
            <div className="p-3 border-b border-slate-200 sticky top-0 bg-white">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 border border-slate-200 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                />
              </div>
            </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          {value === voice.value && <Check className="w-4 h-4 text-amber-500 flex-shrink-0" />}
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <span className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-orange-50 to-orange-100 text-xs font-semibold text-orange-700 rounded-full border border-orange-200">
                            {voice.accent}
                          </span>
