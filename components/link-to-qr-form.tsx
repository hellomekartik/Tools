  ...
  return (
    <div className="max-w-2xl mx-auto mb-12 px-4">
      <div className="text-center mb-8">
        <h2 className="text-4xl font-bold text-foreground mb-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 bg-indigo-50/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 text-foreground placeholder-muted-foreground transition-all duration-200"
            disabled={loading}
          />
          <button
            type="submit"
